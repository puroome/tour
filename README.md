...
장소 기초 정보만 추가하고 문제·보기·정답이 비어 있는 행은 아직 완성된 퀴즈가 아니므로 앱 카드에 표시되지 않습니다. H~N열의 퀴즈 내용을 작성한 뒤 앱에서 새로고침하세요. `퀴즈 빈 행 정리`는 TourAPI의 통합 행정명도 지도에서 사용하는 광역시 이름으로 함께 보정합니다.
